...
import { FaGlobe, FaMedal, FaPeopleGroup, FaCheckDouble } from 'react-icons/fa6'
...
export default function WhyChooseUs() {
    ...
    return (
        <Fragment>
            <h2 className="text-4xl mt-8 font-bold text-secondary text-center">Why Choose Us</h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 transition ease-in mt-4">
                { data.map((d, i) => (
                    <div key={i} className="bg-white shadow-md hover:shadow-xl rounded p-8 flex flex-col items-center gap-4 text-secondary">
                        { d.icon }
